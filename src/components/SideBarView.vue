<template>
  <div class="sidebar" :class="isMobile ? 'collapse' : ''">
    <span class="logo">S</span>
    <a class="logo-expand" href="#">CRM.io</a>
...
const resizeHandler = () => {
  ...
  console.log(width < 680)
  isMobile.value = width < 680
}
onMounted(() => {
  resizeHandler()
})
